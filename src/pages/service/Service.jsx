...
// import discountRed from "../../assets/Service/Logo/discountRed.svg";
...
<<<<<<< HEAD
    return(<div className="min-h-screen flex flex-wrap justify-center items-center">
      <h1 className="font-black text-7xl">Service Page</h1>
    </div>)
=======
  ...
  return (
    <div className="service">
      ...
      <PriceList listTable={priceList[displayIndex]} />
      <CTASection />
    </div>
  );
>>>>>>> 64e96bca9a518415f6540ea25c43d9e1a3b94ac4
}
